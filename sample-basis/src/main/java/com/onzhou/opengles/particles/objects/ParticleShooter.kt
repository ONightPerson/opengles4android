 ...
 */
package com.onzhou.opengles.particles.objects
...
class ParticleShooter(
    ...
    angleVarianceInDegrees: Float, private val speedVariance: Float
) {

    private val angleVariance: Float = angleVarianceInDegrees
