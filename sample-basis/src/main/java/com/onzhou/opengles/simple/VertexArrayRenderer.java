...
public class VertexArrayRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //编译
        final int vertexShaderId = ShaderUtils.compileVertexShader(ResReader.readResource(R.raw.vertex_array_shader));
        final int fragmentShaderId = ShaderUtils.compileFragmentShader(ResReader.readResource(R.raw.fragment_array_shader));
        //鏈接程序片段
